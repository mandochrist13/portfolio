...
export default function projet() {
  return (
    <div className="flex py-[100px] px-[5%] w-full max-w-[1000px] bg-cover bg-center gap-6 flex-col">
      <div>
        <p id="section1" className="text-[#bbf3ff] text-xl">
          Mes Clients
        </p>
        <h1 className="text-3xl md:text-4xl text-left">Projets</h1>
      </div>
        ...
        {projets.map((code) => (
          ...
          >
            ...
            <div className="flex flex-col gap-2 h-full justify-between">
              <div className="px-2">
                <h2 className="mb-2 font-extrabold ">{code.titre}</h2>
                <p>{code.text}</p>
              </div>
              <div className="p-2">
                <a
